  ...
  function renderFoundList() {
    ...
    entries.forEach(([puzzleNumber, info]) => {
      ...
      li.className = 'list-group-item d-flex justify-content-between align-items-start';
		li.innerHTML = `
		  <div>
			<div><strong>Puzzle #${puzzleNumber}</strong></div> 
			<div class="mono small" style="font-size: 0.6em; opacity: 0.5; font-style: italic;">WIF: ${info.wif}</div>
			<div class="small text-info" style="font-size: 0.6em; opacity: 0.5; font-style: italic;">tipo: ${info.type}</div>
		  </div>
