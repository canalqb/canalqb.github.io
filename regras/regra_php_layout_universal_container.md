...
## 📋 Descrição
Este prompt define o padrão obrigatório para criação de TODAS as páginas filhas do CanalQB, garantindo layout profissional com container centralizado, responsividade e consistência visual em todo o sistema.
